...
export function parseWebAPIErrors(response: any): string[] {
    ...
    if (response.error){
        if (typeof response.error === 'string'){
            ...
            ///this part is because the webapi errors in register component returns a string[];
...
export function formatDateFormData(date: Date){
    ...
    //yyyy-MM-dd
    //omg everytime the backticks get me.... backticks, backticks, backticks for the interpolation.
